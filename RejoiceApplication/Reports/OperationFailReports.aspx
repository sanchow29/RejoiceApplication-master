<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OperationFailReports.aspx.cs" Inherits="RejoiceApplication.Reports.OperationFailReports" %>
                        ...
                        <div class="panel-body">
                           ...
                           <%-- <form name="occupancy_report" id="occupancy_report" action="" method="post">--%>
                                ...
                                <div class="form-group col-md-3 button-possition">
                                    ...
                                    <input type="submit" name="view_fail_operation" value="Go" class="btn btn-info" />
