            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "../GetService.asmx/GetAdminList",
                        success: function(data) {
                            var datatableVariable = $('#accountant_list').DataTable({
                                data: data,
                                columns: [
                                    { 'data': 'UserId' },
                                    { 'data': 'UserFirstName' },
                            ...
                            $('#accountant_list tfoot th').each(function() {
                                var placeHolderTitle = $('#accountant_list thead th').eq($(this).index()).text();
                                $(this).html(
