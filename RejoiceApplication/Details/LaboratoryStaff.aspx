            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "../GetService.asmx/GetTechnicianList",
                        success: function(data) {
                            var datatableVariable = $('#laboratrystaff_list').DataTable({
                                data: data,
                                columns: [
                                    { 'data': 'UserId' },
                                    { 'data': 'UserFirstName' },
                            ...
                            $('#laboratrystaff_list tfoot th').each(function() {
                                var placeHolderTitle = $('#laboratrystaff_list thead th').eq($(this).index()).text();
                                $(this).html(
