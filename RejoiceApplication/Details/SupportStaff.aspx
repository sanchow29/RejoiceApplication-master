            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    $.ajax({
                        type: "POST",
                        dataType: "json",
                        url: "../GetService.asmx/GetSupportStaffList",
                        success: function(data) {
                            var datatableVariable = $('#staff_list').DataTable({
                                data: data,
                                columns: [
                                    { 'data': 'UserId' },
                                    { 'data': 'UserFirstName' },
                            ...
                            $('#staff_list tfoot th').each(function() {
                                var placeHolderTitle = $('#staff_list thead th').eq($(this).index()).text();
                                $(this).html(
