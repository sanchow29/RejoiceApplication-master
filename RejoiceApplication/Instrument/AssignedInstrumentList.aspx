                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="instrument_lists" class="display" cellspacing="0" width="100%">
                            ...
                            <td class="bed_number">
                                <a href="?dashboard=user&page=instrument&tab=assign_instrument&action=edit&assign_instument_id=1">Anna Sanz</a>
                            </td>
                            ...
                            <td class="bed_number">
                                <a href="?dashboard=user&page=instrument&tab=assign_instrument&action=edit&assign_instument_id=2">Lucas M</a>
                            </td>
                            <td class="bed_type">Verumak</td>
                            ...
                            <td class="bed_number">
                                <a href="?dashboard=user&page=instrument&tab=assign_instrument&action=edit&assign_instument_id=6">Nina Cadela</a>
                            </td>
                            <td class="bed_type">Verumak</td>
                            ...
                            <td class="bed_number">
                                <a href="?dashboard=user&page=instrument&tab=assign_instrument&action=edit&assign_instument_id=7">Eugene Ciervo</a>
                            </td>
                            <td class="bed_type">Verumak</td>
                            ...
                            <tr>
                                ...
                                <td class="bed_number">
                                    <a href="?dashboard=user&page=instrument&tab=assign_instrument&action=edit&assign_instument_id=8">Lucas M</a>
                                </td>
                                <td class="bed_type">Verumak</td>
