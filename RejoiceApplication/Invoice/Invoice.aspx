                            ...
                            <table id="tblinvoice" class="display dataTable" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="title"><a href="?dashboard=user&page=invoice&tab=addinvoice&action=edit&invoice_id=1">ashish invoice</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="title"><a href="?dashboard=user&page=invoice&tab=addinvoice&action=edit&invoice_id=2">anna invoice</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="title"><a href="?dashboard=user&page=invoice&tab=addinvoice&action=edit&invoice_id=12">Zeeshan Asghar Consultation</a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="title"><a href="?dashboard=user&page=invoice&tab=addinvoice&action=edit&invoice_id=13"></a></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="title"><a href="?dashboard=user&page=invoice&tab=addinvoice&action=edit&invoice_id=17">Blood Bath</a></td>
                                        <td class="patient">P20319</td>
                                        <td class="">210.00</td>
                                        <td class="adjustment_amount">0.00</td>
                                        <td class="">0.00</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="title"><a href="?dashboard=user&page=invoice&tab=addinvoice&action=edit&invoice_id=18"></a></td>
