<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddMedicines.aspx.cs" Inherits="RejoiceApplication.MedicinesDetails.AddMedicines" %>
...
<div class="tab-pane fade active in">
    ...
    <div class="panel-body">
        ...
        <form name="medicine_form" action="" method="post" class="form-horizontal" id="medicine_form">
            ...
            <input type="hidden" id="_wpnonce" name="_wpnonce" value="f8907b3008"/><input type="hidden" name="_wp_http_referer" value="/mojoomla/extend/wordpress/hospital/?dashboard=user&amp;page=medicine&amp;tab=addmedicine&amp;action=insert"/>
