    ...
    function(jQuery) {
        ...
        (function($) {
            ...
            $.expr.pseudos.aicontains = function(obj, index, meta) {
                var $obj = $(obj).find('a');
                var haystack = ($obj.data('tokens') || $obj.data('normalizedText') || $obj.text()).toString()
                    .toUpperCase();
                return haystack.includes(meta[3].toUpperCase());
            };
            ...
            Selectpicker.prototype = {
                ...
                createLi: function() {
                    ...
                    $selectOptions.each(function(index) {
                        ...
                        if (that.options.hideDisabled && (isDisabled && !isOptgroup || isOptgroupDisabled)) {
                            ...
                            $this.next().data('prevHiddenIndex',
                        ...
                        if (isOptgroup && $this.data('divider') !== true) {
                            if (that.options.hideDisabled && isDisabled) {
                                if ($parent.data('allOptionsDisabled') === undefined) {
                                    ...
                                    $parent.data('allOptionsDisabled',
                            ...
                            if ($this.index() === 0) { // Is it the first option of the optgroup?
                                ...
                                var label = $parent[0].label,
                                    labelSubtext = typeof $parent.data('subtext') !== 'undefined'
                                        ? '<small class="text-muted">' + $parent.data('subtext') + '</small>'
                                        : '',
                                ...
                                label =
                                    labelIcon + '<span class="text">' + htmlEscape(label) + labelSubtext + '</span>';
                            ...
                            _li.push(
                                generateLI(generateA(text, optionClass, inline, tokens), index, 'hidden is-hidden'));
                        } else {
                ...
                setSize: function() {
                    ...
                    var that = this,
                        ...
                        getPos = function() {
                            ...
                            selectOffsetRight =
                                $window.width() - selectOffsetLeft - selectWidth - containerPos.left - winPad[1];
                        ...
                        var getSize = function() {
                            ...
                            if (that.options.dropupAuto) {
                                that.$newElement.toggleClass('dropup',
                                    selectOffsetTop > selectOffsetBot && (menuHeight - menuExtras.vert) < getHeight);
                            }
                ...
                togglePlaceholder: function() {
                    ...
                    this.$button.toggleClass('bs-placeholder',
                        value === null || value === '' || (value.constructor === Array && value.length === 0));
                },
                        ...
                        function(e) {
                            ...
                            if (!that.isDisabled() && !$this.parent().hasClass('disabled')) {
                                ...
                                if (!that.multiple) { // Deselect all others if not multi select box
                                    ...
                                    that.$menuInner.find('.selected').removeClass('selected').find('a')
                                ...
                                if ($hideItems.length === $searchBase.length) {
                                    ...
                                    $lisVisible.each(function(index) {
                                        ...
                                        if ($this.hasClass('divider')) {
                                            ...
                                            $lisVisible.eq(index + 1).data('optgroup') !== $this.data('optgroup')) {
                                            $this.addClass('hidden');
                                        } else {
                                            $foundDiv = null;
                                        }
