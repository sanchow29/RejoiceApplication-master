<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AppoitnmentTime.aspx.cs" Inherits="RejoiceApplication.Appointments.AppoitnmentTime" %>
...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="c17f43e6d2"/><input type="hidden" name="_wp_http_referer" value="/mojoomla/extend/wordpress/hospital/?dashboard=user&amp;page=appointment&amp;tab=appointment_time"/>
...
<input type="hidden" id="_wpnonce" name="_wpnonce" value="7b17eb64d4"/><input type="hidden" name="_wp_http_referer" value="/mojoomla/extend/wordpress/hospital/?dashboard=user&amp;page=appointment&amp;tab=appointment_time"/>
<div class="col-sm-offset-2 col-sm-8">
