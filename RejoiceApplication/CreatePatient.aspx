...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fluid">
        <div class="page-inner" style="min-height: 1050px;">
                    ...
                    .patient_registraion_form {
                        ...
                        .patient_registraion_form .form-group {
                            ...
                            .patient_registraion_form .form-group, .patient_registraion_form .form-group .form-control {
                                ...
                                .patient_registraion_form .form-group .require-field {
                                    color: red;
                                }
                        ...
                        .patient_registraion_form .form-group .col-sm-8 {
                            width: 66.66666667%;
                        }

                        .patient_registraion_form .form-group .col-sm-7 {
                            width: 53.33333333%;
                        }

                        .patient_registraion_form .form-group .col-sm-1 {
                            width: 13.33333333%;
                        }
            ...
            <script type='text/javascript'>
                <br />
                    <b>Warning</b>: include_once(): http:// wrapper is disabled in the server configuration by allow_url_include=0 in <b>/home/pushnift/public_html/mojoomla/extend/wordpress/hospital/wp-content/plugins/hospital-management/settings.php</b> on line <b>2101</b><br />
                <br />
                    <b>Warning</b>: include_once(http://pushnifty.com/mojoomla/extend/wordpress/hospital/wp-content/plugins/assets/js/lang/en.js): failed to open stream: no suitable wrapper could be found in <b>/home/pushnift/public_html/mojoomla/extend/wordpress/hospital/wp-content/plugins/hospital-management/settings.php</b> on line <b>2101</b><br />
                        <br />
                        <b>Warning</b>: include_once(): Failed opening 'http://pushnifty.com/mojoomla/extend/wordpress/hospital/wp-content/plugins/assets/js/lang/en.js' for inclusion(include_path = '.:/opt/alt/php72/usr/share/pear') in <b>/home/pushnift/public_html/mojoomla/extend/wordpress/hospital/wp-content/plugins/hospital-management/settings.php</b> on line < b > 2101</b > <br />
            </script>
