<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PharmasistDashboard.aspx.cs" Inherits="RejoiceApplication.Dashboards.PharmasistDashboard" %>
...
<div class="row">
    ...
    <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3">
        <a href="../MedicinesDetails/Medicines6.aspx">
            <div class="panel info-box panel-white">
                <div class="panel-body medicine">
                    ...
                    <img src="../images/dashboard/medicine.png" class="dashboard_background">
                </div>
            </div>
        </a>
    </div>
